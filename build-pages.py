...
<div class="absolute left-0 top-full hidden group-hover:block group-focus-within:block bg-primary border border-on-primary/10 min-w-[240px] py-2 shadow-xl">
<a href="/commercial-roofing-fresno" class="block px-5 py-3 hover:bg-secondary hover:text-on-secondary">Fresno &amp; Clovis</a>
<a href="/spray-foam-roofing-visalia" class="block px-5 py-3 hover:bg-secondary hover:text-on-secondary">Visalia</a>
<a href="/spray-foam-roofing-tulare" class="block px-5 py-3 hover:bg-secondary hover:text-on-secondary">Tulare</a>
<a href="/spray-foam-roofing-hanford" class="block px-5 py-3 hover:bg-secondary hover:text-on-secondary">Hanford</a>
<a href="/spray-foam-roofing-merced" class="block px-5 py-3 hover:bg-secondary hover:text-on-secondary">Merced &amp; Madera</a>
<a href="/spray-foam-roofing-bakersfield" class="block px-5 py-3 hover:bg-secondary hover:text-on-secondary">Bakersfield</a>
</div>
</div>
<div class="relative group">
...
<a href="/commercial-roofing-fresno" class="block px-6 py-3 text-on-primary font-label-caps uppercase text-[12px]">Fresno &amp; Clovis</a>
<a href="/spray-foam-roofing-visalia" class="block px-6 py-3 text-on-primary font-label-caps uppercase text-[12px]">Visalia</a>
<a href="/spray-foam-roofing-tulare" class="block px-6 py-3 text-on-primary font-label-caps uppercase text-[12px]">Tulare</a>
<a href="/spray-foam-roofing-hanford" class="block px-6 py-3 text-on-primary font-label-caps uppercase text-[12px]">Hanford</a>
<a href="/spray-foam-roofing-merced" class="block px-6 py-3 text-on-primary font-label-caps uppercase text-[12px]">Merced &amp; Madera</a>
<a href="/spray-foam-roofing-bakersfield" class="block px-6 py-3 text-on-primary font-label-caps uppercase text-[12px]">Bakersfield</a>
...
<ul class="space-y-3 font-body-md text-on-primary-container text-sm">
<li><a class="hover:text-secondary transition-colors" href="/commercial-roofing-fresno">Fresno &amp; Clovis</a></li>
<li><a class="hover:text-secondary transition-colors" href="/spray-foam-roofing-visalia">Visalia</a></li>
<li><a class="hover:text-secondary transition-colors" href="/spray-foam-roofing-tulare">Tulare</a></li>
<li><a class="hover:text-secondary transition-colors" href="/spray-foam-roofing-hanford">Hanford</a></li>
<li><a class="hover:text-secondary transition-colors" href="/spray-foam-roofing-merced">Merced &amp; Madera</a></li>
<li><a class="hover:text-secondary transition-colors" href="/spray-foam-roofing-bakersfield">Bakersfield</a></li>
</ul>
</div>
<div>
